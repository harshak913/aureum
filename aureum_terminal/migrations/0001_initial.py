# Generated by Django 3.1.5 on 2021-04-08 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_order', models.IntegerField(blank=True, null=True)),
                ('header_order', models.IntegerField(blank=True, null=True)),
                ('accession_number', models.ForeignKey(db_column='accession_number', on_delete=django.db.models.deletion.CASCADE, to='aureum_terminal.scrape')),
            ],
        ),
    ]
